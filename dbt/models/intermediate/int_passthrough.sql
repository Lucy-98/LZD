...
select
    ...
    coalesce(f12, 0.0) as category_affinity_score,
    ...
    coalesce(f24, 0.0) as basket_stability_score,
    ...
    coalesce(f31, 0.0) as campaign_fatigue_score,
    coalesce(f34, 0.0) as quality_index_b,
